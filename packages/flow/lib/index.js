...
import { Group, Rect, Text, Circle, Line, useStrictMode, Stage, Layer } from 'react-konva';
...
var FlowModel = /** @class */ (function () {
    function FlowModel(eventSender) {
        ...
        this.deleCell = function (id) {
            var matchCellIndex = _this.canvasData.cells.find(function (cell) { return cell.id === id; });
            _this.canvasData.cells.splice(matchCellIndex, 1);
        };
        ...
        this.createCellData = function (component, initOptions) {
            var id = v4();
            var metaData = _this.componentsMap.get(component).getMetaData();
            return Object.assign(metaData, __assign({ id: id }, initOptions));
        };
        this.addNode = function () {
            _this.canvasData.cells = _this.canvasData.cells.concat([
                _this.createCellData("TuringNode", {
                    x: 400,
                    y: 400,
                    label: "NEW NODE",
                }),
    ...
    __decorate([
        action
    ], FlowModel.prototype, "addNode", void 0);
    return FlowModel;
}());
...
var Cell = /** @class */ (function (_super) {
    ...
    function Cell(props, context) {
        ...
        context.model.cellsMap.set(props.id, _this);
        return _this;
    }
    Cell.registComponent = function (model) {
    ...
    Cell.prototype.render = function () {
        return jsxRuntime.exports.jsx(jsxRuntime.exports.Fragment, { children: this.content() }, void 0);
    };
...
var Port$1 = /** @class */ (function (_super) {
    ...
    Port.prototype.linkTo = function () { };
    Port.prototype.onLinkStart = function (e) { };
    Port.prototype.onLinkMove = function (e) { };
    Port.prototype.onLinkEnd = function (e) { };
    Port.prototype.content = function () {
        var _this = this;
        return (jsxRuntime.exports.jsx(Group, __assign({ ref: this.wrapperRef, onMouseDown: function (e) { return _this.onLinkStart(e); }, onMouseMove: function (e) { return _this.onLinkMove(e); }, onMouseUp: function (e) { return _this.onLinkEnd(e); } }, { children: this.props.children }), void 0));
    };
    return Port;
}(Cell$1));
...
var Interactor = /** @class */ (function (_super) {
    ...
    Interactor.prototype.render = function () {
        var _this = this;
        var _a = this, model = _a.context.model, _b = _a.props, x = _b.x, y = _b.y, _c = _b.draggable, draggable = _c === void 0 ? true : _c, id = _b.id, _d = _b.selectable, selectable = _d === void 0 ? true : _d;
        return (jsxRuntime.exports.jsx(Group, __assign({ x: x, y: y, draggable: draggable, onMouseDown: function (e) {
                if (selectable) {
                    e.cancelBubble = true;
                    model.setSelectedCells(id);
                }
            }, onDragMove: function (e) {
                _this.syncDragPosition(e);
...
var MatrixNode = /** @class */ (function (_super) {
    ...
    function MatrixNode() {
        ...
        _this.getStroke = function () {
            var isSelect = _this.context.model.selectCells.includes(_this.props.id);
    ...
    MatrixNode.prototype.content = function () {
        ...
        var _c = this.props, x = _c.x, y = _c.y, label = _c.label;
        return (jsxRuntime.exports.jsxs(Interactor, __assign({}, this.props, { children: [jsxRuntime.exports.jsx(Rect, { width: WIDTH, height: HEIGHT, fill: "white", shadowColor: "black", shadowBlur: 10, shadowOpacity: 0.1, cornerRadius: 10 }, void 0), jsxRuntime.exports.jsxs(Group, { children: [jsxRuntime.exports.jsx(Rect, { cornerRadius: [10, 10, 0, 0], width: WIDTH, height: 40, fill: color.grey }, void 0), jsxRuntime.exports.jsx(Text, { fontSize: 14, text: label, height: 40, x: 20, verticalAlign: "middle" }, void 0), jsxRuntime.exports.jsx(Button, { x: WIDTH, width: 20, height: 40, text: "\uFF0B", onClick: function (e) {
                                // model.sendEvent(e);
                                var a = model.createCellData("MatrixNode");
                                console.log(a);
                                debugger;
                            } }, void 0)] }, void 0), jsxRuntime.exports.jsx(Rect, __assign({ width: WIDTH, height: HEIGHT }, getStroke(), { cornerRadius: 10 }), void 0), jsxRuntime.exports.jsx(Group, __assign({ y: 40 }, { children: (_a = this.props.ports) === null || _a === void 0 ? void 0 : _a.map(function (portData, index) { return (jsxRuntime.exports.jsx(Port, __assign({ linkable: true }, portData, { anchor: function () {
                            return {
                                x: x + 200,
                                y: y + 65 + index * 30,
                            };
                        } }, { children: jsxRuntime.exports.jsxs(Group, __assign({ x: 150, y: 20 + index * 30 }, { children: [jsxRuntime.exports.jsx(Text, { text: portData.label }, void 0), jsxRuntime.exports.jsx(Circle, { stroke: color.primary, fill: "white", y: 6, x: 50, radius: 10 }, void 0)] }), void 0) }), portData.id)); }) }), void 0)] }), void 0));
    };
    MatrixNode.metaData = {
        fields: [{}],
        label: "",
...
var Edge = /** @class */ (function (_super) {
    ...
    Edge.prototype.getPoints = function () {
        var model = this.context.model;
        var sourceAnchor = model.cellsMap.get(this.props.source).props.anchor();
        var targetAnchor = model.cellsMap.get(this.props.target).props.anchor();
    ...
    Edge.prototype.edgeRender = function () {
        ...
        return (jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [jsxRuntime.exports.jsx(Line, __assign({ stroke: color.deepGrey, points: this.getPoints(), strokeWidth: 3 }, this.getStroke(), { lineCap: "round", bezier: true }), void 0), jsxRuntime.exports.jsx(Line, { stroke: "transparent", points: this.getPoints(), strokeWidth: 20, lineCap: "round", bezier: true }, void 0)] }, void 0));
    };
    Edge.prototype.content = function () {
        return (jsxRuntime.exports.jsx(Interactor, __assign({ id: this.props.id, draggable: false }, { children: this.edgeRender() }), void 0));
    };
    return Edge;
}(Cell$1));
...
var renderComponent = function (cellData, model) {
    return React.createElement(model.componentsMap.get(cellData.component), __assign(__assign({}, cellData), { key: cellData.id }));
};
var renderComponents = function (cellsData, model) {
    return (jsxRuntime.exports.jsxs(Layer, { children: [jsxRuntime.exports.jsx(Group, { children: cellsData
                    // 先渲染注册节点，后渲染注册线
                ...
                }) }, void 0), jsxRuntime.exports.jsx(Group, { children: cellsData
                    .filter(function (cellData) { return cellData.type === "edge"; })
                    .map(function (cellData) {
                    model.cellsDataMap.set(cellData.id, cellData);
                    return renderComponent(cellData, model);
...
var Canvas = observer(function (props) {
    ...
    useStrictMode(true);
    return (jsxRuntime.exports.jsx(Stage, __assign({ onMouseDown: function () {
            model.clearSelect();
...
var Flow = /** @class */ (function (_super) {
    ...
    function Flow(props) {
        ...
        props.modelRef.current = _this.flowModel;
...
export { Cell$1 as Cell, Flow, Interactor, Port$1 as Port };
