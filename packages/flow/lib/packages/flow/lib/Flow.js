...
import LinkingEdge$1 from './cells/LinkingEdge.js';
...
import SelectBoundsRect$1 from './scaffold/SelectBoundsRect.js';
...
import './cells/Node.js';
import './cells/Edge.js';
import './scaffold/Interactor.js';
import './scaffold/Port.js';
...
const InteractTop = observer((props) => {
    ...
    return (React.createElement(Layer, { zIndex: 3, ref: topLayerRef },
        React.createElement(LinkingEdge$1, { data: model.buffer.link }),
        React.createElement(SelectBoundsRect$1, null)));
});
