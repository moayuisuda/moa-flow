import { injectable } from '../../../_mana-syringe@0.3.1@mana-syringe/es/decorator.js';
import '../../../_mana-syringe@0.3.1@mana-syringe/es/container.js';
import { Module } from '../../../_mana-syringe@0.3.1@mana-syringe/es/module/index.js';
...
var containerModule = Module(function (register) {
  inversify.decorate(injectable(), _eventemitter3_4_0_7_eventemitter3.exports.EventEmitter); // bind DisplayObject pool
