...
import { parseTransformOrigin } from '../parser/transform-origin.js';
...
function () {
  ...
  CSSPropertyTransformOrigin = __decorate([singleton()], CSSPropertyTransformOrigin);
  return CSSPropertyTransformOrigin;
}();

export { CSSPropertyTransformOrigin };
